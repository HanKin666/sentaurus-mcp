...
不知道自己用的是 SSH 还是 VNC，或只拿到了端口和密码，可以从下面的“快速开始”让助手逐项引导。
...
我是新手，目前只知道端口号和密码，不确定是 VNC 还是 SSH。
...
**只有“端口号＋密码”还不足以确定服务器**，至少还需要地址。助手应帮助你找到缺少的信息，而不是反复要求你填写完整技术配置。
